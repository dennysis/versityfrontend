    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-indigo-800 overflow-hidden">
              ...
              <div className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div className="sm:text-center lg:text-left">
                  <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                    ...
                    <span className="block text-indigo-300 xl:inline">meaningful volunteer work</span>
                  </h1>
                  <p className="mt-3 text-base text-indigo-200 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                    ...
                    Find your perfect match, track your hours, and make a difference.
                  </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <div className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full bg-indigo-400">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Versity makes it easy to find, apply for, and track volunteer opportunities.
            </p>
          </div>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Find Opportunities</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Browse and search for volunteer opportunities that match your skills and interests.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Track Hours</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Log and verify your volunteer hours to build a verifiable record of your service.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Connect with Organizations</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Build relationships with organizations that align with your values and interests.
                  </p>
                </div>
              </div>
            </div>
