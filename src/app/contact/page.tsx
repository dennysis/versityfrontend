    ...
    <div className="bg-white min-h-screen">
                ...
                <div className="p-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 mt-1">support@versity.org</p>
                  ...
                  <div className="mt-10">
                    ...
                    <div className="flex space-x-4">
                      <a href="#" className="bg-gray-100 hover:bg-gray-200 p-3 rounded-full text-gray-600 transition-colors">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <button
                      ...
                      className="bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 transition duration-200 disabled:opacity-50"
                    >
      ...
      {toastVisible && (
        <motion.div
          ...
          exit={{ opacity: 0, y: 50 }}
          className="fixed bottom-6 right-6 bg-green-100 border border-green-300 text-green-800 px-6 py-4 rounded-lg shadow-md z-50"
        >
